<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); // security comes first!
/**
 * Name:    Ion Auth
 * Author:  Ben Edmunds
 ...
 *
 *
 * Based on Ion Auth Version: 3
 *
 * Location: http://github.com/benedmunds/CodeIgniter-Ion-Auth
 * --- end of modified description ---
 */
//--- not on original source:
//$config['collections']['users']          = 'users';
//$config['collections']['authentications']= 'external_auths'; // for Hybrid-Auth Library..
...
*/
$tbl_prefix = 'sys_';
$config['tables']['tbl_prefix'] = $tbl_prefix;
$config['tables']['users']           = $tbl_prefix.'users';
//--- todo: not on original source, prepare for hybridauth integration:
$config['tables']['authentications'] = $tbl_prefix.'external_auths'; // for Hybrid-Auth Library..
$config['tables']['users_authentications'] = $tbl_prefix.'users_external_auths'; // for Hybrid-Auth Library..
$config['tables']['groups']          = $tbl_prefix.'groups';
$config['tables']['users_groups']    = $tbl_prefix.'users_groups';
$config['tables']['login_attempts']  = $tbl_prefix.'login_attempts';
 ...
 */
$config['site_title']                 = "Ion Auth on ESCI CodeIgniter";       // Site Title, example.com
$config['admin_email']                = "eurekasolusi@gmail.com"; // Admin Email, admin@example.com
// todo: should be sanity check, if default_group, admin_group not exists ???
$config['default_group']              = 'sys_users';             // Default group, use name
...
//--- todo: not on original source, prepare for hybridauth integration:
$config['identity_cookie_name'] = 'identity'; // for Hybrid-Auth Library..
